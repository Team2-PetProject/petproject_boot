...
public class ItemController {
	...
	public ComResponseEntity<JoinItemDTO> itemList(@PathVariable("cat") String cat,
	...
	public ComResponseEntity<ItemRetrieveDTO> itemRetrieve(@PathVariable("itCd") Integer itCd) {
		...
		return new ComResponseEntity<ItemRetrieveDTO>(
				new ComResponseDTO<ItemRetrieveDTO>(itCd + "상품정보", itemRetrieveDTO));
	}
